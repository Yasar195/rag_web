					...
					<div class="px-6 pt-4 pb-0 border-t border-gray-100">
						...
						<div class="flex flex-col gap-3">
							...
							<div class="flex items-center justify-end gap-3">
								<button type="button" onclick={() => { if (activeConfigureBot) { editBotName = activeConfigureBot.name; editBotDescription = activeConfigureBot.description || ''; editBotSystemPrompt = activeConfigureBot.systemPrompt || ''; } }} class="px-4 py-2 rounded-lg border border-gray-200 text-sm text-gray-600 bg-white hover:bg-gray-50">Reset</button>
